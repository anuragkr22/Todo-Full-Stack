package com.springboot.todorestapi.TodoRestApiApplication.jwt;
...
public class JwtSecurityConfig {
	...
	public UserDetailsService userDetailsService() {
		UserDetails user = User.withUsername("anurag").password("{noop}password").authorities("read").roles("USER")
		    .build();
